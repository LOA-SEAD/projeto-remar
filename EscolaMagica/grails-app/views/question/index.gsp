...
<table class="highlight" id="table" style="margin-top: -30px;">
    ...
    <tr>
        ...
        <th style="cursor: pointer;" id="levelLabel" onclick="sortTableByLevel()">Nível <div class="row" style="margin-bottom: -10px;"><button  class="btn-floating" style="visibility: hidden"></button></div></th>
        <th style="cursor: pointer;" id="statementLabel" onclick="sortTableByName()">Pergunta <div class="row" style="margin-bottom: -10px;"><button  class="btn-floating" style="visibility: hidden"></button></div></th>
        <th style="cursor: pointer;" id="answerLabel" onclick="sortTableByAnswer()">Respostas <div class="row" style="margin-bottom: -10px;"><button  class="btn-floating" style="visibility: hidden"></button></div></th>
        <th style="cursor: pointer;" id="correctAnswerLabel" onclick="sortTableByCorrectAnswer()">Alternativa Correta <div class="row" style="margin-bottom: -10px;"><button  class="btn-floating" style="visibility: hidden"></button></div></th>
    ...
    <g:each in="${questionInstanceList}" status="i" var="questionInstance">
        <tr id="tr${questionInstance.id}" class="selectable_tr" style="cursor: pointer;"
            ...
            <td> <i onclick="_edit($(this.closest('tr')))" style="margin-right:10px;" class="fa fa-pencil remar-orange-text" ></i></td>
        </tr>
    </g:each>
    </tbody>
</table>
            ...
            <g:form action="save" resource="${questionInstance}">
                ...
                <div class="row">
                    <div class="input-field col s9">
                        ...
                        <input type="text" class="remar-input validate" id="answers[3]" name="answers[3]" required="" value="${questionInstance?.answers}" maxlength="13" length="13">
                    </div>
                    <div class="col s2">
...
<div id="editModal" class="modal remar-modal">
    <g:form method="post" action="update" resource="${questionInstance}">
                ...
                <div class="col s12">
                    <div class="row">
                        <div class="input-field col s12">
                            ...
                            <input id="editTitle" name="title" required=""  type="text" class="remar-input validate" maxlength="250" length="250">
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s9">
                    ...
                    <div class="row">
                        <div class="input-field col s9">
                            ...
                            <input type="text" class="remar-input" id="editAnswers3" name="answers4" required="" maxlength="13" length="13">
                        </div>
                        <div class="col s2">
        ...
        <div class="modal-footer">
            <button name="update" class="modal-action modal-close btn waves-effect waves-light remar-orange">Salvar</button>
        </div>
    </g:form>
</div>
