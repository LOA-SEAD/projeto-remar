                            ...
                            <table class="" id="tableMyTheme">
                                ...
                                <g:each in="${themeInstanceListMy}" status="i" var="themeInstance">
                                    <tr data-id="${themeInstance.id}" class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                        ...
                                        <td align="center"><img src="/forca/data/${themeInstance.ownerId}/themes/${themeInstance.id}/icon.png" class="" width="200"/></td>
                                        <td align="center"><img src="/forca/data/${themeInstance.ownerId}/themes/${themeInstance.id}/inicio.png" class="" width="200"/></td>
                                        <td align="center"><img src="/forca/data/${themeInstance.ownerId}/themes/${themeInstance.id}/papel.png" class="" width="200"/></td>
