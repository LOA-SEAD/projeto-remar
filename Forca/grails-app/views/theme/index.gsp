...
<div class="row">
    <div>
        ...
        <p style="margin-left: 10px;">Download do tema modelo
            <a class="btn-floating waves-effect waves-light my-orange" href="/forca/samples/tema-forca.zip">
                        ...
                        <table class="" id="tableMyTheme">
                            ...
                            <g:each in="${themeInstanceListMy}" status="i" var="themeInstance">
                                <tr data-id="${themeInstance.id}" class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                    <td class="simpleTable myTheme" align="center"><input class="with-gap" name="radio"
                                                                                          type="radio" id="myTheme${i}"
                                                                                          value="${themeInstance.id}" ${i == 0 ? "checked" : ""}> <label
                                            for="myTheme${i}"></label>
                                    </td>
                                    <td align="center"><img
                                            src="/forca/data/${themeInstance.ownerId}/themes/${themeInstance.id}/icon.png"
                                            class="" width="150"/></td>
                                    <td align="center"><img
                                            src="/forca/data/${themeInstance.ownerId}/themes/${themeInstance.id}/inicio.png"
                                            class="" width="150"/></td>
                                    <td align="center"><img
                                            src="/forca/data/${themeInstance.ownerId}/themes/${themeInstance.id}/papel.png"
                                            class="" width="150"/></td>
                                    <td align="center"><i id="deleteIcon${i}" style="color: #7d8fff"
                                                          class="material-icons delete">delete</i></td>
                                </tr>
                            </g:each>
                            </tbody>
                        </table>
                ...
                <div class="collapsible-body">
                    <table class="" id="tablePublicTheme">
                        ...
                        <g:each in="${themeInstanceListPublic}" status="i" var="themeInstance">
                            <tr data-id="${themeInstance.id}" class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                <td class="simpleTable" align="center"><input class="with-gap" name="radio" type="radio"
                                                                              id="publicTheme${i}"
                                                                              value="${themeInstance.id}" ${i == 0 ? "checked" : ""}> <label
                                        for="publicTheme${i}"></label>
                                </td>
                                <td align="center"><img
                                        src="/forca/data/${themeInstance.ownerId}/themes/${themeInstance.id}/icon.png"
                                        class="" width="200"/></td>
