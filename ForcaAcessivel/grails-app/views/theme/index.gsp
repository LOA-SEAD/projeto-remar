...
<%@ page import="br.ufscar.sead.loa.forcaacessivel.remar.Theme" %>
<!DOCTYPE html>
<html>
    <head>
    ...
    <div class="row">
        <div>
            ...
            <p style="margin-left: 10px;">Download do tema modelo <a class="btn-floating waves-effect waves-light my-orange" href="/forca_acessivel/samples/tema-forca.zip">  </a>
        </p>
        </div>
    </div>
                            ...
                            <table class="" id="tableMyTheme">
                                ...
                                <g:each in="${themeInstanceListMy}" status="i" var="themeInstance">
                                    <tr data-id="${fieldValue(bean: themeInstance, field: "id")}" class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                        ...
                                        <td align="center"><img src="/forca_acessivel/data/${fieldValue(bean: themeInstance, field: "ownerId")}/themes/${fieldValue(bean: themeInstance, field: "id")}/icon.png" class="" width="200"/></td>
                                        <td align="center"><img src="/forca_acessivel/data/${fieldValue(bean: themeInstance, field: "ownerId")}/themes/${fieldValue(bean: themeInstance, field: "id")}/inicio.png" class="" width="200"/></td>
                                        <td align="center"><img src="/forca_acessivel/data/${fieldValue(bean: themeInstance, field: "ownerId")}/themes/${fieldValue(bean: themeInstance, field: "id")}/papel.png" class="" width="200"/></td>
