...
function sendFormDataEdit(blobA, blobB) {
    ...
    var cond1 = (blobA != null) || ($("#audio-1")[0].files[0] != null) || (selectPerg == "gerar") || (selectPerg == "naoeditar");
    var cond2 = (blobB != null) || ($("#audio-2")[0].files[0] != null) || (selectResp == "gerar") || (selectResp == "naoeditar");
