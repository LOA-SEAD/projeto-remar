	...
	<body>
		...
		<div id="show-anotacao" class="content scaffold-show" role="main">
			...
			<ol class="property-list anotacao">
				...
				<g:if test="${anotacaoInstance?.informacao}">
				<li class="fieldcontain">
					<span id="informacao-label" class="property-label"><g:message code="anotacao.informacao.label" default="Informacao" /></span>
					
						<span class="property-value" aria-labelledby="informacao-label"><g:fieldValue bean="${anotacaoInstance}" field="informacao"/></span>
