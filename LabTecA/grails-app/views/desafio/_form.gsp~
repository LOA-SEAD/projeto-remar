	...
	<li style="transform: translateX(0px); opacity: 0; display:none">
		...
		<div class="collapsible-body">
			<div class="row">
				...
				<!-- Volume Inicial -->
				<div class="input-field col s6">
					<input disabled readonly class="validate" id="volume-inicial" type="number" step="any">
				...
				<!-- Molaridade Inicial -->
				<div class="input-field col s6">
					<input class="validate" id="molaridade-inicial" type="number" step="any">
		...
		<div class="collapsible-body">
			<div class="row">
				...
				<div class="fieldcontain ${hasErrors(bean: desafioInstance, field: 'volFinal', 'error')} required input-field col s6">
					<input class="validate" id="volume-final" type="number" step="any">
				...
				<div class="fieldcontain ${hasErrors(bean: desafioInstance, field: 'molFinal', 'error')} required input-field col s6">
					<input class="validate" id="molaridade-final" type="number" step="any">
