...
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'br.ufscar.sead.loa.remar.UserUserRole'
grails.plugin.springsecurity.authority.className = 'br.ufscar.sead.loa.remar.UserRole'
