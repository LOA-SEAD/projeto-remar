                    ...
                    <div class="card hoverable">
                        ...
                        <div class="card-content">
                            ...
                            <span style="color: dimgrey; font-size: 0.9em" class="center truncate">Feito por:
                                <a href="#!" style="color: margin-right:10px; cursor:pointer; font-style:normal"
                        ...
                        <div class="card-reveal col l12">
                            <div class="row">
                                <h5 class="card-title grey-text text-darken-4 col l12"><small
                                ...
                                <div class="center">
                                    <div class="col l4">
                                        <a style="font-size: 2em;" href="/exported-resource/info/${instance.id}"
                                           class="tooltipped" data-position="down" data-delay="50"
