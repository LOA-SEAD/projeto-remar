                    ...
                    <div class="card hoverable">
                        ...
                        <div class="card-reveal col s12">
                            ...
                            <div class="row">
                                <g:if test="${instance.resource.web}">
                                    <div class="col s6 m4 l3">
                                        <a target="_blank" href="/published/${instance.processId}/web"
                                           class="tooltipped"
                            ...
                            <div class="license-info license-image-only center-align"
                                 data-license="${instance.license}"></div>
                        </div>
                    </div>
                </div>
            </g:each>
    ...
    %{--Modal for groups--}%
        ...
        <div class="modal-wrapper-50">
            <div id="modal-delete-exported-resource" class="modal remar-modal">
                <div class="modal-content">
                    <h4><g:message code="exportedResource.label.deleteCustomizingGame"
                                   default="Excluir Jogo em Customização"/></h4>

                    <p><g:message code="exportedResource.label.confirmAction"
                                  default="Tem certeza que deseja realizar esta ação?"/></p>
                </div>

                <div class="modal-footer">
                    <a id="confirmDeleteExpResource"
                       class="modal-action modal-close btn waves-effect waves-light remar-orange">Sim</a>
