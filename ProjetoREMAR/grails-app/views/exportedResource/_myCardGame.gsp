                ...
                <div id="card${instance.id}" data-instance_id="${instance.id}" class="col l3 s5 fullCard">
                    <div class="card hoverable">
                        <div class="card-image waves-effect waves-light">
                            <img alt="${instance.name}" class="activator"
                                 src="/published/${instance.processId}/banner.png">
                        </div>

                        <div class="card-content">
                            <span style="font-size: 1.3em"
                                  class="card-title grey-text text-darken-4 activator center-align truncate"
                            ...
                            <span style="color: dimgrey;" class="center">
                                <g:if test="${instance.resource.web}">
                        ...
                        <div class="card-reveal">
                            <div class="row">
                                <h5 class="card-title grey-text text-darken-4 activator col l12 truncate"><small
                                        class="left">Jogar:</small><i class="material-icons right">close</i></h5><br>
                                <g:if test="${instance.resource.web}">
                                    <div class="col l4">
                                        <a style="font-size: 2em; color: black;" target="_blank"
                                           href="/published/${instance.processId}/web" class="tooltipped"
                                           data-position="right" data-delay="50" data-tooltip="Web"><i
                                ...
                                <g:if test="${instance.resource.desktop}">
                                    ...
                                    <div class="col l4">
                                        <a style="font-size: 2em; color: black;" target="_blank"
                                           href="/published/${instance.processId}/desktop/${instance.resource.uri}-windows.zip"
                                           class="tooltipped" data-position="right" data-delay="50"
                                ...
                                <div class="col l4">
                                    <g:if test="${instance.resource.android}">
                                        <a style="font-size: 2em; color: black;" target="_blank"
                                           href="/published/${instance.processId}/mobile/${instance.resource.uri}-android.zip"
                                           class="tooltipped" data-position="right" data-delay="50"
                                ...
                                <div class="col l4">
                                    <g:if test="${instance.resource.moodle}">
                                        <a style="font-size: 2em; color: black;" class="tooltipped"
                                           data-position="right" data-delay="50" data-tooltip="Disponível no Moodle"><i
                                ...
                                <div class="center">
                                    <div class="col l4">
                                        <a style="font-size: 2em;" href="/exported-resource/info/${instance.id}"
                                           class="tooltipped" data-position="down" data-delay="50" cursor="grab"
                                    ...
                                    <div class="col l4">
                                        <a style="font-size: 2em;" onclick="deleteResource(${instance.id})"
                                           class="tooltipped" data-position="down" data-delay="50" cursor="pointer"
                                    ...
                                    <g:if test="${instance.resource.shareable}">
                                        <div class="col l4">
                                            <a style="font-size: 2em;" href="#modal-group"
                                               class="tooltipped compartilhaModal" data-position="down" data-delay="50"
                                    ...
                                    <g:else>
                                        <div class="col l4">
                                            <div style="font-size: 2em;" class="tooltipped" data-position="down"
                                                 data-delay="50" data-tooltip="Sem compartilharmento para grupos">
