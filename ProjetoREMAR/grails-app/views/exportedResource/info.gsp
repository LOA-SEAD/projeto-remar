    ...
    <div class="row show">
        <div class="row">
            ...
            <ul data-instance_id="${exportedResourceInstance.id}" class="collapsible popout infos-exportedResource"
                        ...
                        <div class="row" style="margin-top: 30px">
                            <div id="platforms-icons" class="col s12"
                                ...
                                <g:if test="${exportsTo.desktop}">
                                    <a href="/published/${exportedResourceInstance.processId}/desktop/${exportedResourceInstance.resource.uri}-windows.zip"
                                       style="color: inherit">
                                ...
                                <g:if test="${exportsTo.android}">
                                    <a href="/published/${exportedResourceInstance.processId}/mobile/${exportedResourceInstance.resource.uri}-android.zip"
                                       style="color: inherit">
                ...
                <li id="reportAbuse">
                    <div class="collapsible-header"><g:message code='exportedResource.label.reportAbuse'
                                                               default='Reportar abuso'/></div>

                    <div class="collapsible-body"><p><g:message
                            code='exportedResource.message.reportAbuseDisclaimer'/></p>
                        ...
                        <g:form action="reportAbuse">
                            ...
                            <div class="row">
                                <div class="input-field col s12 m12 l12">
                                    ...
                                    <label for="message"><g:message code='exportedResource.label.message'
                                                                    default='Mensagem'/></label>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="input-field col s6 m7 offset-m3 l7 offset-l3">
                                    <div class="g-recaptcha text-center"
                                         data-sitekey="6Le6wh8UAAAAAP9Gs9OkQEWIZZBcQJDHWht_zYpG"></div>
                                </div>
                            </div>
...
<div id="modal-picture" class="modal">
    ...
    <div class="modal-footer">
        <a href="#!" class="modal-action modal-close waves-effect btn-flat"><g:message
                code='exportedResource.label.send' default='Enviar'/></a>
    </div>
</div>
