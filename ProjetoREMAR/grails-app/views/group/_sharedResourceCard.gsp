    ...
    <div class="row">
        <g:if test="${groupExportedResources.size() > 0}">
            <g:each in="${groupExportedResources}" var="groupExportedResource">
                ...
                <div id="card${groupExportedResource.exportedResource.id}"
                     data-groupExportedResource.exportedResource_id="${groupExportedResource.exportedResource.id}"
                    ...
                    <div class="card hoverable">
                        ...
                        <div class="card-content">
                            <span class="card-title flow-text grey-text text-darken-4 activator valign-wrapper truncate no-padding"
                                  data-category="${groupExportedResource.exportedResource.resource.category.id}"
                                  title="${groupExportedResource.exportedResource.name}">
                            ...
                            <span class="truncate">
                                ...
                                <a href="#!" class="user-profile"
                                   id="user-id-${groupExportedResource.exportedResource.owner.id}">
                ...
                <div class="modal-wrapper-50">
                    <div id="modal-confirmation-exported-resource-${groupExportedResource.id}"
                        ...
                        <div class="modal-content">
                            ...
                            <p><g:message code="group.message.confirmAction"
