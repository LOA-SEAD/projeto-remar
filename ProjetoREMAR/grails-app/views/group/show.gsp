        ...
        <div class="cluster-header">
            <div id="main-header" class="row" style="margin-bottom: 0px">
                ...
                <div class="col s6">
                    <div class="row right-align" style="margin-bottom: 0px">
                        <g:if test="${group.owner.id == session.user.id}">
                            <div class="row" style="margin:0px;">
                                <g:link action="edit" id="${group.id}" class="tooltipped" data-position="left"
                                        data-delay="30" data-tootip="Gerenciar Grupo">
                    ...
                    <div class="row right-align" style="margin-bottom: 0px">
                        <a href="#modal-users" class="modal-trigger"
                           style="font-size: 1.2em; left: -2.8em; position: relative"><span
                                class="right group-size"
                                data-group-size="${group.userGroups.size() + 1}">Ver membros (${group.userGroups.size() + 1})</span>
                        </a>
                        <g:if test="${!group.owner.id == session.user.id}">
                            <p align="left"
                               style="font-size: 1.2em;">Dono: ${group.owner.firstName + " " + group.owner.lastName}</p>
                        </g:if>
                    </div>
                </div>
            </div>
                    ...
                    <div style="position: relative; left: 1em">
                        <g:if test="${!groupExportedResources.empty}">
                            <g:each var="groupExportedResource" in="${groupExportedResources}">
                                <div class="col l3 s5">
                                    <div id="card-group-exported-resource-${groupExportedResource.id}"
                                        ...
                                        <div class="card-content">
                                            ...
                                            <span style="color: dimgrey;" class="center">
                                                <g:if test="${groupExportedResource.exportedResource.resource.web}">
                                                ...
                                                <g:if test="${groupExportedResource.exportedResource.resource.desktop}">
                                                    ...
                                                    <i class="tooltipped fa fa-linux" data-position="bottom"
                                                ...
                                                <div class="col l4">
                                                    <g:if test="${groupExportedResource.exportedResource.resource.moodle}">
                                                        <a style="font-size: 2em; color: black;" class="tooltipped"
                                                           ...
                                                           data-tooltip="Disponível no Moodle"><i
            ...
            <g:else>
                <g:each var="userGroup" in="${group.userGroups.sort { it.user.firstName }}">
                    <li id="user-group-card-${userGroup.id}" class="collection-item avatar left-align">
                        ...
                        <g:if test="${group.owner.id == session.user.id}">
                            <!--a href="teste" id="${userGroup.id}" style="position: relative; top: -2.5em; left: -1.6em;"
