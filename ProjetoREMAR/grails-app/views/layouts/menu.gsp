...
<ul id="side-nav">
    ...
    <li class="waves-effect waves-block waves-light" data-intro="Aqui você acompanha o rendimento de todas as pessoas que já jogaram seu jogo customizado." data-step="4">
        <a href="/exportedResource/stats" class=""><i class="medium material-icons">equalizer</i>Estatísticas</a>
    </li>
    <li class="waves-effect waves-block waves-light" data-intro="Aqui você encontra os seus jogos em processo de customização." data-step="5">
        <a href="/process/list" class=""><i class="medium material-icons">list</i>Meus processos</a>
    </li>
    <li class="waves-effect waves-block waves-light hide-on-med-and-down" data-intro="Aqui você encontra e gerencia as informações do seu perfil." data-step="6">
        <a href="/my-profile"><i class="medium material-icons">account_circle</i>Meu perfil</a>
    </li>
    <li class="waves-effect waves-block waves-light" data-intro="Aqui você se conecta com as diferentes instâncias do Moodle e gerencia suas contas." data-step="7">
        <a href="/my-profile#moodle" class=""><i class="fa fa-graduation-cap medium"></i>Contas do Moodle</a>
    </li>
    <sec:ifAllGranted roles="ROLE_DEV">
        <li class="waves-effect waves-block waves-light" data-intro="No espaço do desenvolvedor você pode submeter um novo jogo para o REMAR." data-step="8">
            <a href="/resource/index" class=""><i class="medium material-icons">code</i>Desenvolvedor</a>
        </li>
    </sec:ifAllGranted>

    <li class="waves-effect waves-block waves-light" data-intro="Para ver este wizard novamente basta clicar aqui." data-step="9">
