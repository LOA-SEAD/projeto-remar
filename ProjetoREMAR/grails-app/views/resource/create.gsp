...
<div class="modal-wrapper-50">
	<div id="modal-exportdata" class="modal remar-modal">
		...
		<div class="modal-footer">
			<a id="cancel-import" class="btn modal-action modal-close"><g:message code="default.button.cancel.label"/></a>
			<a id="send-import" class="btn"><g:message code="default.button.submit.label"/></a>
		</div>
	</div>
</div>
