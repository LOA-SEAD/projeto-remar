            ...
            <div class="card col l12 s11 m11" style="position: relative; left: 1.2em;">
                <div class="col l12">
                    <div class="card-content">
                        ...
                        <div class="col l6 s4 m7">
                            <span class="card-title black-text truncate left" style="font-size: 1.6em;"
                                  data-id="${resourceInstance.id}">${resourceInstance.name}</span><br>
                        </div>
                        ...
                        <div class="col l8 m7 s7">
                            <img class="col l2 s5 m3"
                                 src="/data/users/${resourceInstance.owner.username}/profile-picture"
                                 alt="Contact Person">
                            <span style="color: dimgrey"
                                  class="left">${resourceInstance.owner.firstName} ${resourceInstance.owner.lastName}</span><br>
                            <span style="color: dimgrey"
                                  class="hide-on-small-only left">${resourceInstance.owner.email}</span>
                            ...
                            <div class="plataform gray-color">
                                ...
                                <div class="">
                                    <g:if test="${resourceInstance.web}">
                                        <i class="fa fa-globe tooltipped" data-position="bottom" data-delay="30"
                                           data-tooltip="Web"></i>
                                    </g:if>
                                    <g:if test="${resourceInstance.android}">
                                        <i class="fa fa-android tooltipped" data-position="bottom" data-delay="30"
                                           data-tooltip="Android"></i>
                                    </g:if>
                                    <g:if test="${resourceInstance.desktop}">
                                        <i class="fa fa-windows tooltipped" data-position="bottom" data-delay="30"
                                           data-tooltip="Windows"></i>
                                        <i class="fa fa-linux tooltipped" data-position="bottom" data-delay="30"
                                           data-tooltip="Linux"></i>
                                        <i class="fa fa-apple tooltipped" data-position="bottom" data-delay="30"
                                           data-tooltip="Mac"></i>
                                    </g:if>
                                    <g:if test="${resourceInstance.moodle}">
                                        <i class="fa fa-graduation-cap tooltipped" data-position="bottom"
                                           data-delay="30" data-tooltip="Moodle"></i>
                                    </g:if>
                        ...
                        <div class="col l8 m9">
                            <div class="plataform gray-color">
                                <p class=""
                                   style="font-size: 16px; display: inline-block;"><b>Grupos (Compartilhamento):</b></p>
                ...
                <div class="slider" style="margin-top: 50px;">
                    <ul class="slides">
                        ...
                        <li><img src="/data/resources/assets/${resourceInstance.uri}/description-1" width="auto"
                                 height="400px"></li>
                        <li><img src="/data/resources/assets/${resourceInstance.uri}/description-2" width="auto"
                                 height="400px;"></li>
                        <li><img src="/data/resources/assets/${resourceInstance.uri}/description-3" width="auto"
                                 height="400px;"></li>
                    </ul>
                </div>
                ...
                <div class="row">
                    <div class="col s12 m12 l12">
                        <p class="description"
                           style="text-align: justify"><b>Descrição:</b> ${resourceInstance.description}</p>
                    </div>
                </div>

                <div class="row">
                    <div class="col s12 m12 l12">
                        <p style="text-align: justify"><b>Itens customizáveis:</b> ${resourceInstance.customizableItems}
                        </p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col s12 m12 l12">
                        ...
                        <g:else>
                            <p><b>Vídeo Tutorial:</b><a target="_blank"
                                                        href="${resourceInstance.videoLink}">Clique aqui</a></p>
                        </g:else>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col s12 m12 l12" id="documentation">
                        ...
                        <g:else>
                            <p><b>Documentação do Modelo:</b><a target="_blank"
                                                                href="${resourceInstance.documentation}">${resourceInstance.name}</a>
                            </p>
                        </g:else>
                    </div>
                </div>
                ...
                <div class="card-action">
                    ...
                    <a href="#modal-comment"
                       class="modal-trigger btn-floating btn-large waves-effect waves-light right tooltipped"
                        ...
                        <g:if test="${resourceInstance.ratings.size() > 0}">
                            <g:each in="${resourceInstance.ratings.sort { it.date }.reverse()}" var="rating">
                                <li id="rating${rating.id}" class="collection-item avatar">
                                    ...
                                    <img src="/data/users/${rating.user.username}/profile-picture"
                                         alt="${rating.user.firstName}" class="circle">

                                    <g:if test="${rating.user.id == session.user.id}">
                                        <ul id='dropdown${rating.id}' class='my-dropdown'>
                                            <li>
                                                <a title="Editar" onclick="editRating(${rating.id})" class="edit-rating"
                                                   id-rating="${rating.id}">
                                                    <i class="fa fa-pencil"></i>
                                                </a>
                                            </li>
                                            <li>
                                                <a title="Excluir" onclick="deleteRating(${rating.id})"
                                                   class="delete-rating" id-rating="${rating.id}">
                                                    <i class="fa fa-trash"></i>
                                                </a>
                                            </li>
                                        </ul>
                                        <a id="more-vert" class='right dropdown-button' href='#'
                                           data-activates='dropdown${rating.id}'>
                                            <i class="material-icons">more_vert</i>
                                        </a>
                                    </g:if>

                                    <g:if test='${(rating.date - today) < 0}'>
                                        <p class="title">${rating.user.firstName} <small>- <g:formatDate
                                                format="dd/MM/yyyy" date="${rating.date}"/></small></p>
                                    </g:if>
                                    <g:else>
                                        <p class="title">${rating.user.firstName} <small>- <g:formatDate format="HH:mm"
                                                                                                         date="${rating.date}"/></small>
                                        </p>
                                    </g:else>
                                    <p class="rating-desc">${rating.comment}</p>

                                    <div id="rateYo${rating.id}" class="left rating-stars"
                                         style="display: inline-block;" data-stars="${rating.stars}"
...
<div id="modal-comment" class="modal remar-modal">
            ...
            <form class="col s12">
                ...
                <div class="row">
                    <div class="input-field center">
                        ...
                        <span id="comment-error" class="invalid-textarea"
                              style="display: block; left: 2.75rem;">Este campo não pode ser vazio!</span>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="modal-footer">
        <a href="#!" id="create-rating"
           class="modal-action modal-close btn waves-effect waves-light remar-orange">Enviar</a>
        <a href="#!" id="edit-rating"
           class="modal-action modal-close btn waves-effect waves-light remar-orange">Salvar</a>
