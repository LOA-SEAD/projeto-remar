                        ...
                        <div class="col l12 s12 m9 no-padding">
                            <div class="platform gray-color no-margin">
                                ...
                                <g:if test="${resourceInstance.moodle}">
                                    <i class="fa fa-graduation-cap tooltipped" data-position="bottom" data-delay="30"
                                       data-tooltip="Moodle"></i>
                                </g:if>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="stars">
                                ...
                                <g:else>
                                    <div id="rateYo-main" style="display: inline-block;"
                                         data-stars="${resourceInstance.sumStars * 2 / resourceInstance.sumUser}"></div>
                                </g:else>
    ...
    <div class="row">
        ...
        <div class="row">
            <div class="col s12 m12 l7">
                ...
                <g:else>
                    <p><strong>Vídeo Tutorial:</strong><a target="_blank"
        ...
        <div class="row">
            <div class="col s12 m12 l7" id="documentation">
                ...
                <g:else>
                    <p><strong>Documentação do Modelo:</strong><a target="_blank"
                        ...
                        <li id="rating${rating.id}" class="collection-item avatar">
                            ...
                            <g:if test="${rating.user.id == session.user.id}">
                                <ul id='dropdown${rating.id}' class='my-dropdown'>
                                    ...
                                    <li>
                                        <a title="Excluir" onclick="deleteRating(${rating.id})" class="delete-rating"
                                           id-rating="${rating.id}">
                            ...
                            <g:if test='${(rating.date - today) < 0}'>
                                <p class="title">${rating.user.firstName} <small>- <g:formatDate format="dd/MM/yyyy"
