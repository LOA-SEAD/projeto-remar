...
<div class="row">
    <div class="container-fluid" style="margin: 7% auto; width: 30%;">
    ...
    <g:form action="newDeveloper" controller="resource">
        ...
        <div class="form-group" style="margin: 10px;">
            <input placeholder="Cidade" type="text" class="form-control input-form" name="city" id="city" required=""/>
        </div>
        <div class="form-group" style="margin: 10px;">
            <input placeholder="Data Nascimento (dd/mm/aaaa)" type="text" class="form-control input-form" name="birthday" id="birthday" required=""/>
        </div>
        <div class="form-group" style="margin: 10px;">
            ...
            <textarea placeholder="Motivos para ser um desenvolvedor do REMAR" class="form-control input-form" name="reasons" id="reasons" cols="30" rows="5"required=""></textarea>
        </div>
    ...
    %{--<label for="fullName" style="margin-top: 10px;"> Nome Completo--}%
