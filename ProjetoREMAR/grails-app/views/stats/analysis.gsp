...
<div id="estatisticasAlunoDiv">
  ...
  <div style="border: 1px solid; border-color: gray; border-radius: 5px; margin-top: 5px; margin-right: 5px; margin-left: 5px">
    ...
    <div class="container-fluid" style="justify-content: center; margin-top: 10px">
      <!-- inicio do formulário de desafios -->
      <p class="center-align">
        <label for="cmbSelectChallengeUser" style="font-size: 12pt">Escolha um desafio para obter informações detalhadas:</label>
        <select id="cmbSelectChallengeUser" style="display: inline; width: 300px" class="browser-default" required onchange="selectChallengeUser()">
          <option id="defaultSelectChallengeUser" selected>Selecione...</option>
        </select>
      </p>
    </div>

    <!-- container dos gráficos de frequencia de escolhas por desafio de cada aluno -->
    <div class="container" id="choicesChallengesUserDiv" style="margin-top: 10px">
      <div class="row" style="margin-bottom: 10px">
        <div id="playerFrequenceChoiceDiv" class="col s12 m12 l12 center-align">
          <!-- Frequência de escolhas por desafio de cada aluno -->
        </div>
      </div>
    </div>
  </div>
