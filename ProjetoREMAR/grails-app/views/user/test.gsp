...
<div id="modal" class="modal modal-fixed-footer">
    <div class="modal-content">
        ...
        <div class="row">
            <div class="header-search-wrapper">
                ...
                <input type="text" id="userSearch" class="header-search-input z-depth-2"
    ...
    <div class="modal-footer">
        <a href="#!" class="modal-action modal-close waves-effect waves-green btn-flat green lighten-1"
           style="margin-left: 10px">Escolher</a>
