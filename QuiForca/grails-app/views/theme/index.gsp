...
<html>
    ...
    <div class="cluster-header">
        <p class="text-teal text-darken-3 left-align margin-bottom" style="font-size: 28px;">
            <i class="small material-icons left"></i>Temas
        </p>
    </div>
    ...
    <div class="row">
        <div>
            ...
            <p style="margin-left: 10px;">Download do tema modelo <a class="btn-floating waves-effect waves-light my-orange" href="/forca/samples/tema-forca.zip"> <i class="material-icons">file_download</i> </a>
        </p>
        </div>
    </div>
                            ...
                            <table class="" id="tableMyTheme">
                                ...
                                <g:each in="${themeInstanceListMy}" status="i" var="themeInstance">
                                    <tr data-id="${fieldValue(bean: themeInstance, field: "id")}" class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                        ...
                                        <td align="center"><img src="../data/${fieldValue(bean: themeInstance, field: "ownerId")}/themes/${fieldValue(bean: themeInstance, field: "id")}/papel.png" class="" width="200"/></td>
