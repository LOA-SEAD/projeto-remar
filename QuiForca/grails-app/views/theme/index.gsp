...
<html>
    ...
    <div class="row">
        <div>
            ...
            <p style="margin-left: 10px;">Download do tema modelo <a class="btn-floating waves-effect waves-light my-orange" href="../samples/tema-forca.zip"> <i class="material-icons">file_download</i> </a>
        </p>
        </div>
    </div>
