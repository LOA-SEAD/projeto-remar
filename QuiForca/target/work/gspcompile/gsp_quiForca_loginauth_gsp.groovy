...
class gsp_quiForca_loginauth_gsp extends GroovyPage {
...
createTagBody(2, {->
printHtmlPart(1)
invokeTag('message','g',73,['code':("Login por Facebook")],-1)
printHtmlPart(1)
})
invokeTag('login-button','fb',73,['perms':("email,public_profile"),'scope':("public_profile,email,publish_actions,user_about_me"),'onlogin':("facebookLogin();"),'size':("large")],2)
printHtmlPart(9)
