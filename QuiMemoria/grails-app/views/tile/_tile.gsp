    ...
    <div class="col s4">
        <div class="row no-margin">
            <div class="tile-image col no-padding s6">
                ...
                <img class="materialboxed" alt="${tileInstance.content} - A" data-caption="${tileInstance.content} - A" src="/quimemoria/data/${tileInstance.ownerId}/tiles/tile${tileInstance.id}-a.png"/>
            </div>
            <div class="tile-image col no-padding s6">
                <label>${tileInstance.content} - B</label>
                <img class="materialboxed" alt="${tileInstance.content} - B" data-caption="${tileInstance.content} - B" src="/quimemoria/data/${tileInstance.ownerId}/tiles/tile${tileInstance.id}-b.png" class="img-responsive max"/>
            </div>
        </div>
    </div>
    %{-- Tile info --}%
