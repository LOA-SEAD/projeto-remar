...
<div class="input-field col s12">
        ...
        <ul class="collapsible" data-collapsible="accordion">
            <li>
                <div class="collapsible-header active"><i
                        class="material-icons">info</i>Informação sobre as transcrições do texto</div>
    ...
    <div class="row" style="vertical-align: middle;">
        ...
        <div class="input-field col s3">
            <div class="custom-select remar-orange">
                <g:select style="display: block;" name="selectLevel" from="${1..3}" value="${questionInstance.level}"/>
            </div>
        </div>
    </div>
    ...
    <div class="row" style="margin-top:5em;">
        <div class="input-field col s9">
            <input id="title" name="title" required value="${questionInstance?.title}" type="text"
    ...
    <div class="row">
        <div class="input-field col s9">
            <input id="answer1" name="answer1" required value="${questionInstance?.answers[0]}" type="text"
                   class="validate remar-input" maxlength="150"/>
            <label for="answer1">
                <span class="required-indicator">*</span>
    ...
    <div class="row">
        <div class="input-field col s9">
            <input id="answer2" name="answer2" required value="${questionInstance?.answers[1]}" type="text"
                   class="validate remar-input" maxlength="150"/>
            <label for="answer2">
                <span class="required-indicator">*</span>
    ...
    <div class="row">
        <div class="input-field col s9">
            <input id="answer3" name="answer3" required value="${questionInstance?.answers[2]}" type="text"
                   class="validate remar-input" maxlength="150"/>
            <label for="answer3">
                <span class="required-indicator">*</span>
    ...
    <div class="row">
        <div class="input-field col s9">
            <input id="answer4" name="answer4" required value="${questionInstance?.answers[3]}" type="text"
                   class="validate remar-input" maxlength="150"/>
            <label for="answer4">
                <span class="required-indicator">*</span>
    ...
    <%--div class="row" style="vertical-align: middle;">
        ...
        <div class="input-field col s3">
            <div class="custom-select remar-orange">
                <g:select style="display: block;" name="selectRespCorreta" from="${1..4}"
    ...
    <div class="row">
        <div class="input-field col s9">
            <input id="hint" name="hint" required="" value="${questionInstance?.hint}" type="text"
    ...
    <div class="input-field col s12" style="display: none;">
        <input type="hidden" id="ownerId" name="ownerId" required="" readonly="readonly"
               value="${questionInstance?.ownerId}" type="text" class="validate remar-input">
        <input type="hidden" id="taskId" name="taskId" required="" readonly="readonly"
               value="${questionInstance?.taskId}" type="text" class="validate remar-input">
        <input type="hidden" id="questionID" name="questionID" required="" readonly="readonly"
               value="${questionInstance?.id}" type="text" class="validate remar-input">
    </div>
</div>
            ...
            <div class="input-field col s6" style="text-align: center">
                ...
                <div style="text-align: left">
                    ...
                    <div id="controlsTitle" style="text-align: center">
                        ...
                        <button type="button" class="btn waves-effect waves-light remar-orange" id="pauseButtonTitle"
                                disabled="true">
                            ${message(code: 'question.pause.button.label', default: 'Pausar gravação')}</button>
                        <button type="button" class="btn waves-effect waves-light remar-orange" id="stopButtonTitle"
                                disabled="true">
                ...
                <div style="text-align: left">
                    ...
                    <div id="controlsB" style="text-align: center">
                        <button type="button" class="btn waves-effect waves-light remar-orange" id="recordButtonAlt1">
                            ${message(code: 'question.record.button.label', default: 'Gravar')}</button>
                        <button type="button" class="btn waves-effect waves-light remar-orange" id="pauseButtonAlt1"
                                disabled="true">
                            ${message(code: 'question.pause.button.label', default: 'Pausar gravação')}</button>
                        <button type="button" class="btn waves-effect waves-light remar-orange" id="stopButtonAlt1"
                                disabled="true">
                            ${message(code: 'question.stop.button.label', default: 'Encerrar gravação')}</button>
                    </div>
                ...
                <div style="text-align: left">
                    ...
                    <div id="controlsB" style="text-align: center">
                        <button type="button" class="btn waves-effect waves-light remar-orange" id="recordButtonAlt2">
                            ${message(code: 'question.record.button.label', default: 'Gravar')}</button>
                        <button type="button" class="btn waves-effect waves-light remar-orange" id="pauseButtonAlt2"
                                disabled="true">
                            ${message(code: 'question.pause.button.label', default: 'Pausar gravação')}</button>
                        <button type="button" class="btn waves-effect waves-light remar-orange" id="stopButtonAlt2"
                                disabled="true">
                            ${message(code: 'question.stop.button.label', default: 'Encerrar gravação')}</button>
                    </div>
                ...
                <div style="text-align: left">
                    ...
                    <div id="controlsB" style="text-align: center">
                        <button type="button" class="btn waves-effect waves-light remar-orange" id="recordButtonAlt3">
                            ${message(code: 'question.record.button.label', default: 'Gravar')}</button>
                        <button type="button" class="btn waves-effect waves-light remar-orange" id="pauseButtonAlt3"
                                disabled="true">
                            ${message(code: 'question.pause.button.label', default: 'Pausar gravação')}</button>
                        <button type="button" class="btn waves-effect waves-light remar-orange" id="stopButtonAlt3"
                                disabled="true">
                            ${message(code: 'question.stop.button.label', default: 'Encerrar gravação')}</button>
                    </div>
                ...
                <div style="text-align: left">
                    ...
                    <div id="controlsB" style="text-align: center">
                        <button type="button" class="btn waves-effect waves-light remar-orange" id="recordButtonAlt4">
                            ${message(code: 'question.record.button.label', default: 'Gravar')}</button>
                        <button type="button" class="btn waves-effect waves-light remar-orange" id="pauseButtonAlt4"
                                disabled="true">
                            ${message(code: 'question.pause.button.label', default: 'Pausar gravação')}</button>
                        <button type="button" class="btn waves-effect waves-light remar-orange" id="stopButtonAlt4"
                                disabled="true">
                            ${message(code: 'question.stop.button.label', default: 'Encerrar gravação')}</button>
                    </div>
                ...
                <div style="text-align: left">
                    ...
                    <div id="controlsB" style="text-align: center">
                        <button type="button" class="btn waves-effect waves-light remar-orange" id="recordButtonHint">
                            ${message(code: 'question.record.button.label', default: 'Gravar')}</button>
                        <button type="button" class="btn waves-effect waves-light remar-orange" id="pauseButtonHint"
                                disabled="true">
                            ${message(code: 'question.pause.button.label', default: 'Pausar gravação')}</button>
                        <button type="button" class="btn waves-effect waves-light remar-orange" id="stopButtonHint"
                                disabled="true">
                            ${message(code: 'question.stop.button.label', default: 'Encerrar gravação')}</button>
                    </div>
                    ...
                    <div class="row">
                        <div class="col s12">
                            <ul class="collapsible" data-collapsible="accordion">
                                <li>
                                    <div class="collapsible-header active"><i
                                            class="material-icons">file_upload</i>Selecione o arquivo referente ao áudio
                                    </div>
                                    ...
                                    <div class="collapsible-body">
                                        <div class="file-field input-field">
                                            <div class="btn right remar-orange waves-effect waves-light">
                                                <span>Arquivo</span>
                                                <input data-image="true" type="file" name="audio-1" id="audio-1"
                                                       class="audio-input" accept="audio/mpeg">
                                            </div>

                                            <div class="file-path-wrapper">
                                                <input class="file-path validate" type="text"
                                                       placeholder="Áudio (.wav, .mp3, etc.)">
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div class="collapsible-body">
                                        <div class="file-field input-field">
                                            <div class="btn right remar-orange waves-effect waves-light">
                                                <span>Arquivo</span>
                                                <input data-image="true" type="file" name="audio-2" id="audio-2"
                                                       class="audio-input" accept="audio/*">
                                            </div>
                                ...
                                <li>
                                    ...
                                    <div class="collapsible-body">
                                        <div class="file-field input-field">
                                            <div class="btn right remar-orange waves-effect waves-light">
                                                <span>Arquivo</span>
                                                <input data-image="true" type="file" name="audio-3" id="audio-3"
                                                       class="audio-input" accept="audio/*">
                                            </div>
                                ...
                                <li>
                                    ...
                                    <div class="collapsible-body">
                                        <div class="file-field input-field">
                                            <div class="btn right remar-orange waves-effect waves-light">
                                                <span>Arquivo</span>
                                                <input data-image="true" type="file" name="audio-4" id="audio-4"
                                                       class="audio-input" accept="audio/*">
                                            </div>
                                ...
                                <li>
                                    ...
                                    <div class="collapsible-body">
                                        <div class="file-field input-field">
                                            <div class="btn right remar-orange waves-effect waves-light">
                                                <span>Arquivo</span>
                                                <input data-image="true" type="file" name="audio-5" id="audio-5"
                                                       class="audio-input" accept="audio/*">
                                            </div>
                                ...
                                <li>
                                    ...
                                    <div class="collapsible-body">
                                        <div class="file-field input-field">
                                            <div class="btn right remar-orange waves-effect waves-light">
                                                <span>Arquivo</span>
                                                <input data-image="true" type="file" name="audio-6" id="audio-6"
                                                       class="audio-input" accept="audio/*">
                                            </div>
