...
<html>
	<head>
		...
		<g:external dir="css" file="pergaminhoCassiano.css"/>
		<script type="text/javascript" src="/sanjarunner/js/pergaminhoCassiano.js"></script>
	</head>
	<body>
		<!--Titulo-->
		<div class="cluster-header">
			<p class="text-teal text-darken-3 left-align margin-bottom" style="font-size: 28px;">
				Fase Cassiano - Criar pergaminho
			</p>
		</div>
		...
		<div class="row">
			...
			<div style=" margin-bottom: 10px; color:#333333">
				...
				Informe abaixo cinco textos que serão inseridos nos pergaminhos do nível Cassiano, mantendo a ordem em que as informações aparecerão no jogo.
			</div>
			...
			<div id="chooseInformations" class="col s12 m12 l12">
				...
				<div class="row">
					<div class="col s12 m12 l12">
						<table class="highlight" id="table" style="margin-top: -30px;">
							...
							<tbody>
							<g:each in="${pergaminhoCassianoInstanceList}" status="i" var="pergaminhoCassianoInstance">
								<tr id="tr${pergaminhoCassianoInstance.id}" class="selectable_tr" style="cursor: pointer;"
									data-id="${fieldValue(bean: pergaminhoCassianoInstance, field: "id")}" data-owner-id="${fieldValue(bean: pergaminhoCassianoInstance, field: "ownerId")}">
									<td>${fieldValue(bean: pergaminhoCassianoInstance, field: "information")}</td>
					...
					<div class="modal-content">
						...
						<div class="row">
							<g:form method="post" action="update" resource="${pergaminhoCassianoInstance}">
								...
								<input type="hidden" id="pergaminhoCassianoID" name="pergaminhoCassianoID">
								<div class="col l10">
				...
				<div id="uploadModal" class="modal">
					<div class="modal-content">
						...
						<div class="row">
							<g:uploadForm  method="post" action="generateInformations" resource="${pergaminhoCassianoInstance}">
