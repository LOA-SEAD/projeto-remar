...
<html>
	<head>
		...
		<g:external dir="css" file="pergaminhoMatriz.css"/>
		<script type="text/javascript" src="/sanjarunner/js/pergaminhoMatriz.js"></script>
	</head>
	<body>
		<!--Titulo-->
		<div class="cluster-header">
			<p class="text-teal text-darken-3 left-align margin-bottom" style="font-size: 28px;">
				Fase Matriz - Criar pergaminho
			</p>
		</div>
		...
		<div class="row">
			...
			<div style=" margin-bottom: 10px; color:#333333">
				...
				Informe abaixo quatro textos que serão inseridos nos pergaminhos do nível Matriz, mantendo a ordem em que as informações aparecerão no jogo.
			</div>
					...
					<div class="modal-content">
						...
						<div class="row">
							<g:form method="post" action="update" resource="${pergaminhoMatrizInstance}">
								...
								<input type="hidden" id="pergaminhoMatrizID" name="pergaminhoMatrizID">
								<div class="col l10">
