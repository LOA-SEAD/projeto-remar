...
<html>
	<head>
		...
		<g:external dir="css" file="pergaminhoSantos.css"/>
		<script type="text/javascript" src="/sanjarunner/js/pergaminhoSantos.js"></script>
	</head>
	<body>
		<!--Titulo-->
		<div class="cluster-header">
			<p class="text-teal text-darken-3 left-align margin-bottom" style="font-size: 28px;">
				Fase Santos - Criar pergaminho
			</p>
		</div>
			...
			<div style=" margin-bottom: 10px; color:#333333">
				...
				<center>
					<div style="margin-top:20px;margin-bottom:15px">
						<img src="https://files.readme.io/07d18e0-santos.png"
							 style="width:400px"/>
					</div>
				</center>
				Informe abaixo cinco textos que serão inseridos nos pergaminhos do nível Santos, mantendo a ordem em que as informações aparecerão no jogo.
			</div>
			...
			<div id="chooseInformations" class="col s12 m12 l12">
				...
				<div class="row">
					<div class="col s12 m12 l12">
						<table class="highlight" id="table" style="margin-top: -30px;">
							...
							<tbody>
							<g:each in="${pergaminhoSantosInstanceList}" status="i" var="pergaminhoSantosInstance">
								<tr id="tr${pergaminhoSantosInstance.id}" class="selectable_tr" style="cursor: pointer;"
									data-id="${fieldValue(bean: pergaminhoSantosInstance, field: "id")}" data-owner-id="${fieldValue(bean: pergaminhoSantosInstance, field: "ownerId")}">
									<td>${fieldValue(bean: pergaminhoSantosInstance, field: "information")}</td>
				...
				<div id="editModal" class="modal">
					<div class="modal-content">
						<h4>Editar Texto</h4>
						<div class="row">
							<g:form method="post" action="update" resource="${pergaminhoSantosInstance}">
								<!--Campos de edicao-->
								<div class="row">
								...
								<div class="row">
									<div class="input-field col s12">
										...
										<input type="text" class="validate" id="editInformation4" name="information5" required="" maxlength="600" length="600"/>
									</div>
								</div>

								<input type="hidden" id="pergaminhoSantosID" name="pergaminhoSantosID">
								<div class="col l10">
				...
				<div id="uploadModal" class="modal">
					<div class="modal-content">
						...
						<div class="row">
							<g:uploadForm  method="post" action="generateInformations" resource="${pergaminhoSantosInstance}">
