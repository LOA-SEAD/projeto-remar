...
class gsp_sanjaRunner_1_santosDumontcreateQuiz_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/santosDumont/createQuiz.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
printHtmlPart(19)
invokeTag('render','g',30,['template':("formQuiz")],-1)
printHtmlPart(20)
...
public static final long LAST_MODIFIED = 1487250380000L
