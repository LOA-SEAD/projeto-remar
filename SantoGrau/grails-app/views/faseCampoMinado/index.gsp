				...
				<div class="row">
					<div class="col s12 m12 l12">
						<table class="highlight" id="table" style="margin-top: -30px;">
							...
							<tbody>
							<g:each in="${faseCampoMinadoInstanceList}" status="i" var="faseCampoMinadoInstance">
							...
							<g:form action="save" resource="${faseCampoMinadoInstance}">
								...
								<div class="row">
									<div class="input-field col s9">
										...
										<input type="text" class="form-control" id="editAnswers3Create" name="answers4" required="" />
									</div>
									<div class="col s2">
								...
								<div class="row">
									<div class="input-field col s9">
										...
										<input type="text" class="form-control" id="editAnswers4Create" name="answers5" required="" />
									</div>
									<div class="col s2">
