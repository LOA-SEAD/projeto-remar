	...
	<body>
		...
		<div class="row">
			<div id="chooseQuestion" class="col s12 m12 l12">
						...
						<table class="highlight" id="table" style="margin-top: -30px;">
							...
							<g:each in="${questionFaseCampoMinadoInstanceList}" status="i" var="faseCampoMinadoInstance">
								<tr id="tr${faseCampoMinadoInstance.id}" class="selectable_tr" style="cursor: pointer;"
									data-id="${fieldValue(bean: faseCampoMinadoInstance, field: "id")}" data-owner-id="${fieldValue(bean: faseCampoMinadoInstance, field: "ownerId")}"
									data-checked="false">
				...
				<div class="row">
					<div class="col s2">
						<g:form method="post"  action="save" resource="${faseCampoMinadoInstance}">
							...
							<g:form method="post" action="update" resource="${faseCampoMinadoInstance}">
								...
								<div class="row">
									<div class="input-field col s9">
										...
										<input type="text" class="form-control" id="editAnswers3" name="answers4" required="" maxlength="49" length="49"/>
									</div>
									<div class="col s2">
								...
								<div class="row">
									<div class="input-field col s9">
										...
										<input type="text" class="form-control" id="editAnswers4" name="answers5" required="" maxlength="49" length="49" />
									</div>
									<div class="col s2">
							...
							<g:form action="save" resource="${faseCampoMinadoInstance}">
								...
								<div class="row">
									<div class="input-field col s9">
										...
										<input type="text" class="form-control" id="editAnswers3Create" name="answers4" required="" maxlength="49" length="49"/>
									</div>
									<div class="col s2">
								...
								<div class="row">
									<div class="input-field col s9">
										...
										<input type="text" class="form-control" id="editAnswers4Create" name="answers5" required="" maxlength="49" length="49"/>
									</div>
									<div class="col s2">
