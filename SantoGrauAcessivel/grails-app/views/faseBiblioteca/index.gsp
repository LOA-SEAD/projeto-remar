...
<head>
	...
	<script type="text/javascript" src="/santograuacessivel/js/faseBiblioteca.js"></script>
</head>
<body>
...
<div class="row">
	<div style=" margin-bottom: 10px; color:#333333">
		Etapa da biblioteca. "texto placeholder"
		<center>
			...
			<div class="col s12 m12 l12">
				<table class="highlight" id="table" style="margin-top: -30px;">
					...
					<tr>
						...
						<th>Dicas <div class="row" style="margin-bottom: -10px;"><button  class="btn-floating" style="visibility: hidden"></button></div></th>
					...
					<g:each in="${questionFaseBibliotecaInstanceList}" status="i" var="faseBibliotecaInstance">
						<tr id="tr${faseBibliotecaInstance.id}" class="selectable_tr" style="cursor: pointer;"
							data-id="${fieldValue(bean: faseBibliotecaInstance, field: "id")}" data-owner-id="${fieldValue(bean: faseBibliotecaInstance, field: "ownerId")}"
							data-checked="false">
							<td class="_not_editable">
								<input style="background-color: #727272" id="checkbox-${faseBibliotecaInstance.id}" class="filled-in" type="checkbox">
							...
							<td> <i style="color: #7d8fff !important; margin-right:10px;" class="fa fa-pencil " onclick="_modal_edit($(this.closest('tr')))" ></i></td>
						</tr>
					</g:each>
					</tbody>
				</table>
					...
					<g:form method="put" action="update" resource="${faseBibliotecaInstance}">
						<div class="row">
							<div class="input-field col s12">
								...
								<input type="text" class="validate" id="editTip1" name="tip1" required="" maxlength="15" length="15"/>
							</div>
						</div>
						...
						<div class="row">
							<div class="input-field col s12">
								...
								<input type="text" class="validate" id="editTip2" name="tip2" required="" maxlength="15" length="15"/>
							</div>
						</div>
						...
						<div class="row">
							<div class="input-field col s12">
								...
								<input type="text" class="validate" id="editTip3" name="tip3" required="" maxlength="15" length="15"/>
							</div>
						</div>
						...
						<div class="row">
							<div class="input-field col s12">
								...
								<input type="text" class="form-control" id="editAnswer" name="answer" required="" maxlength="15" length="15"/>
							</div>
						</div>
					...
					<g:form action="save" resource="${faseBibliotecaInstance}">
						<div class="row">
							<div class="input-field col s12">
								...
								<input type="text" class="validate" id="editTip1Create" name="tip1" required="" maxlength="15" length="15"/>
							</div>
						</div>
						...
						<div class="row">
							<div class="input-field col s12">
								...
								<input type="text" class="validate" id="editTip2Create" name="tip2" required="" maxlength="15" length="15"/>
							</div>
						</div>
						...
						<div class="row">
							<div class="input-field col s12">
								...
								<input type="text" class="validate" id="editTip3Create" name="tip3" required="" maxlength="15" length="15"/>
							</div>
						</div>
						...
						<div class="row">
							<div class="input-field col s12">
								...
								<input type="text" class="form-control" id="editAnswerCreate" name="answer" required="" maxlength="15" length="15"/>
							</div>
						</div>
						<div class="col l10">
