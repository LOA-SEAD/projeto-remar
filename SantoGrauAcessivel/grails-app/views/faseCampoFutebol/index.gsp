...
<head>
	...
	<script type="text/javascript" src="/santograuacessivel/js/faseCampoFutebol.js"></script>
</head>
<body>
...
<div class="row">
	<div style=" margin-bottom: 10px; color:#333333">
		Etapa do campo de futebol. São dois desafios compostos cada um por uma pergunta com uma única resposta.
		<center>
			...
			<div class="col s12 m12 l12">
				<table class="highlight" id="table" style="margin-top: -30px;">
					...
					<tr>
						...
						<th id="titleLabel">Desafio <div class="row" style="margin-bottom: -10px;"><button  class="btn-floating" style="visibility: hidden"></button></div></th>
					...
					<g:each in="${questionFaseCampoFutebolInstanceList}" status="i" var="faseCampoFutebolInstance">
						<tr id="tr${faseCampoFutebolInstance.id}" class="selectable_tr" style="cursor: pointer;"
							data-id="${fieldValue(bean: faseCampoFutebolInstance, field: "id")}" data-owner-id="${fieldValue(bean: faseCampoFutebolInstance, field: "ownerId")}"
							data-checked="false">
							<td class="_not_editable">
								<input style="background-color: #727272" id="checkbox-${faseCampoFutebolInstance.id}" class="filled-in" type="checkbox">
					...
					<g:form method="post" action="update" resource="${faseCampoFutebolInstance}">
						...
						<div class="row">
							<div class="input-field col s9">
								...
								<input type="number" step="any" class="validate" id="editAnswer" name="answer" required="" maxlength="15" length="15"/>
							</div>
						</div>
					...
					<g:form action="save" resource="${faseCampoFutebolInstance}">
						...
						<div class="row">
							<div class="input-field col s12">
								...
								<input type="number" step="any" class="validate" id="editAnswerCreate" name="answer" required="" maxlength="15" length="15"/>
							</div>
						</div>
