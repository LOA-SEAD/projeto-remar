...
<html>
	<head>
        ...
        <script type="text/javascript" src="/santograuinclusivo/js/faseBlocoGelo.js"></script>
					...
					<div class="modal-content">
						...
						<div class="row">
							<div class="col s12">
								...
								<ul>
									<li><a href="/santograuinclusivo/samples/exemploSantoGrauBlocoGelo.csv">Download do arquivo exemplo</a></li>
								</ul>
							</div>
						</div>
						<div class="row">
