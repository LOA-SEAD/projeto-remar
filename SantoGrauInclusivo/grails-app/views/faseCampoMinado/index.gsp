<%@ page import="br.ufscar.sead.loa.santograuinclusivo.remar.QuestionFaseCampoMinado" %>
<!DOCTYPE html>
<html>
	<head>
		...
		<script type="text/javascript" src="/santograuinclusivo/js/faseCampoMinado.js"></script>
	</head>
	<body>
