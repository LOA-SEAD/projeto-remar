...
<html>
	<head>
        ...
        <script type="text/javascript" src="/santograuinclusivo/js/faseTCC.js"></script>
	</head>
	<body>
			...
			<div style=" margin-bottom: 10px; color:#333333">
							...
							<g:each in="${questionFaseTCCInstanceList}" status="i" var="questionFaseTCCInstance">
								<tr id="tr${questionFaseTCCInstance.id}" class="selectable_tr" style="cursor: pointer;"
									...
									<td class="_not_editable">
										...
										<label for="checkbox-${questionFaseTCCInstance.id}"></label>
									</td>
									<td>${fieldValue(bean: questionFaseTCCInstance, field: "title")}</td>
									<td>${fieldValue(bean: questionFaseTCCInstance, field: "answers")}</td>
									<td>${questionFaseTCCInstance.answers[questionFaseTCCInstance.correctAnswer]}</td>
				...
				<div id="editModal" class="modal">
					<div class="modal-content">
						...
						<div class="row">
							<g:form method="post" action="update" resource="${faseTCCInstance}">
								<div class="row">
								...
								<input type="hidden" id="faseTCCID" name="faseTCCID">
								<div class="col l10">
				...
				<div id="createModal" class="modal">
					<div class="modal-content">
						<h4>Criar Questão</h4>
						<div class="row">
							<g:form action="save" resource="${faseTCCInstance}">
								<div class="row">
									<div class="input-field col s12">
					...
					<div class="modal-content">
						...
						<div class="row">
							<div class="col s12">
								...
								<ul>
									<li><a href="/santograuinclusivo/samples/exemploSantoGrau.csv">Download do arquivo exemplo</a></li>
								</ul>
							</div>
						</div>
						<div class="row">
